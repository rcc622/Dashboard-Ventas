...
export const CATALOGO_FECHAS: { vista: string; widgets: { id: string; titulo: string }[] }[] = [
  { vista: 'Dashboard (y los mismos widgets en la ficha del asesor)', widgets: [
    ...
    { id: 'pipeline', titulo: 'Cotizado vs vendido vs meta' }, { id: 'entrada', titulo: 'Entrada de leads · Kommo' }, { id: 'embudo', titulo: 'Embudo de ventas por etapa' },
    { id: 'etapas', titulo: 'Monto cotizado y tiempo por etapa' }, { id: 'llamadas', titulo: 'Llamadas' }, { id: 'calidad-llamadas', titulo: 'Calidad de llamadas' },
  ...
  { vista: 'Solo en la ficha del asesor', widgets: [
    { id: 'ev', titulo: 'Monto vendido y Meta de venta por mes' }, { id: 'ev-tabla', titulo: 'Contrato total y Meta de venta por mes' },
