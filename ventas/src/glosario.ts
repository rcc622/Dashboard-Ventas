...
export const GLOSARIO = {
  ...
  'Cotizaciones': 'Kommo: la primera vez que el lead entró a «Propuesta entregada» según el historial de etapas, una por lead; si vuelve a entrar cuenta como recotización, aparte. Cuenta aunque después lo hayan regresado de etapa y se atribuye al responsable actual del lead. HubSpot: la fecha de entrada a «Propuesta entregada» desde el 4 de agosto de 2026; los deals de antes solo cuentan si hoy siguen en esa etapa.',
